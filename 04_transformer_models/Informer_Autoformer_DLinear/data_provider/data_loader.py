'''This code is orginally from the https://github.com/thuml/Time-Series-Library repo and has been adopted for the purpose of the thesis.'''
import os
import numpy as np
import pandas as pd
import glob
...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        # Create or open a file to capture the prints
        ...
        border1 = border1s[self.set_type]
        border2 = border2s[self.set_type]
        # Print all variables and their names
